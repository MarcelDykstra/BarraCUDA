...
void mexFunction(int nlhs,mxArray *plhs[],int nrhs,const mxArray *prhs[])
{
  ...
  const char *field_names[] = {
    ...
    "memPitch", "maxThreadsPerBlock", "maxThreadsDim", "maxGridSize",
    "totalConstMem", "major", "minor", "clockRate", "textureAlignment",
    "deviceOverlap", "multiProcessorCount","kernelExecTimeoutEnabled",
    "integrated", "canMapHostMemory", "computeMode", "maxTexture1D",
    "maxTexture2D", "maxTexture3D", "concurentKernels"
  };
  mwSize dims[2] = {1, 1};
  mxArray *mtrx;
  double *elem;
